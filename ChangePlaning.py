...
management_changes_button = driver.find_elements_by_class_name('x-panel-header-text') 
management_changes_button[3].click()

managament_search_changes_buton = driver.find_elements_by_class_name('x-tree-node-anchor')
...
input_executor_ZNR_field = driver.find_element_by_id('X12') 
...
input_date_ZNR_field = driver.find_element_by_xpath('//*[@id="X26"]')
input_date_ZNR_field.clear()
input_date_ZNR_field.send_keys(plan_date)


input_comment_field = driver.find_element_by_xpath('//*[@id="X55View"]')
