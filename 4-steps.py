...
remove_WAF_date = ((list_work_day[0]).strftime('%d.%m.%y'))+start_time
remove_DNS_date = ((list_work_day[1]).strftime('%d.%m.%y'))+start_time
CMDB_date = ((list_work_day[2]).strftime('%d.%m.%y'))+start_time
...
ZNR_remove_WAF = driver.find_element(By.XPATH, '//*[@id="X176_2"]')
ZNR_remove_WAF.click()
time.sleep(10)
input_date_ZNR_field = driver.find_element(By.XPATH, '//*[@id="X26"]')
input_date_ZNR_field.clear()
input_date_ZNR_field.send_keys(remove_WAF_date)
actions = ActionChains(driver)\
    .key_down(Keys.CONTROL)\
    .key_down(Keys.SHIFT)\
    .send_keys(Keys.F2)\
...
ZNR_remove_DNS = driver.find_element(By.XPATH, '//*[@id="X176_3"]')
ZNR_remove_DNS.click()
time.sleep(10)
input_date_ZNR_field = driver.find_element(By.XPATH, '//*[@id="X26"]')
input_date_ZNR_field.clear()
input_date_ZNR_field.send_keys(remove_DNS_date)
actions = ActionChains(driver)\
    .key_down(Keys.CONTROL)\
    .key_down(Keys.SHIFT)\
    .send_keys(Keys.F2)\
...
ZNR_CMDB = driver.find_element(By.XPATH, '//*[@id="X176_4"]')
ZNR_CMDB.click()
time.sleep(10)
input_date_ZNR_field = driver.find_element(By.XPATH, '//*[@id="X26"]')
input_date_ZNR_field.clear()
input_date_ZNR_field.send_keys(CMDB_date)
actions = ActionChains(driver)\
    .key_down(Keys.CONTROL)\
    .key_down(Keys.SHIFT)\
    .send_keys(Keys.F2)\
